 ...
 */
inline class NanoTime(val nt: Long) : Comparable<NanoTime> {
 ...
 */
inline class NanoDuration(val ns: Long) : Comparable<NanoDuration> {
 ...
 * @see NanoTime
 */
inline class MicroTime(val ut: Long) {
 ...
 * as it may be negative.
 */
inline class MicroDuration(val us: Long) : Comparable<MicroDuration> {
